...
| Token usage | `input_tokens`/`output_tokens` + cache | Uncached input = upstream total input − cache reads − cache writes; three disjoint input buckets, reported output preserved |
